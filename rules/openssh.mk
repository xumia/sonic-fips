...
$(OPENSSH_SERVER)_SRC = $(SRC_PATH)/openssh
...
$(OPENSSH_SERVER)_PRE_SCRIPT = sudo dpkg -i $(SYMCRYPT_OPENSSL)
...
$(OPENSSH_SERVER)_DERIVED_DEBS += openssh-sftp_$(OPENSSH_VERSION_FIPS)_$(ARCH).deb
